...
# eerdown <a href='https://eremrah.com/eerdown'><img src='man/figures/logo.png' align="right" height="116" /></a>

<!-- badges: start -->
<!-- badges: end -->

A pkgdown theme and template for my packages. [See the demo](https://eremrah.com/eerdown).
...
navbar:
  components:
    github:
      ...
      href: https://github.com/emraher/tezr
```
